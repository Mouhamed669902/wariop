...
ALLOWED_HOSTS = ['ton-nom-de-site.onrender.com', 'localhost', '127.0.0.1']
...
# Redirection après s'être déconnecté
LOGOUT_REDIRECT_URL = '/'
import os
...
# Configuration des Emails (Exemple avec Gmail / SMTP standard)
EMAIL_BACKEND = 'django.core.mail.backends.smtp.EmailBackend'
EMAIL_HOST = 'smtp.gmail.com'
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'omouhamadou69@gmail.com'      # L'email de la plateforme WARIOP
EMAIL_HOST_PASSWORD = 'lqbwblsbzardsxgi' # Mot de passe d'application généré sécurisé
DEFAULT_FROM_EMAIL = f"WARIOP E-commerce <{EMAIL_HOST_USER}>"

# Ton adresse superadmin qui recevra les demandes de validation
